...
gpy-run() {
    ...
    case $target in
        1)
            ...
            python3 lusl progs/$module.py progs/compiled/$module.s
            ;;
        2)
            python3 lusl progs/$module.py progs/compiled/$module.s
    ...
    python3 $LOST/compilers/las progs/compiled/$module.s progs/compiled/$module.bin
    python3 $LOST/compilers/las -export progs/compiled/$module.s progs/compiled/$module.sym || true
    case $mode in
        cli)
